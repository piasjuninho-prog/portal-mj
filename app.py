...
if st.session_state.perfil is None:
    ...
    # --- ABA DASHBOARD (v96.0 - DEDUPLICAÇÃO AGRESSIVA) ---
    if menu == "🏠 Dashboard":
        ...
        try:
            ...
            if v_raw:
                ...
                # DEDUPLICAÇÃO REAL: Garante que vendas idênticas no mesmo dia/hora/valor sejam contadas apenas 1 vez
                df_v = df_v.drop_duplicates(subset=['data_venda', 'bruto', 'ns', 'plano', 'bandeira'], keep='first')
    ...
    # Outras abas (Gestão, Planos, Vincular mantidas v83.0)
    elif menu == "🏫 Gestão":
...
st.sidebar.caption("MJ Soluções v96.0")
