...
menu = st.sidebar.radio("Navegação", ["📊 Dashboard", "👤 Vincular", "🏫 Gestão"])

if menu == "👤 Vincular":
    st.subheader("👤 Vincular Máquina ao Cliente")
    ...
    if v_res.data and m_res.data:
        ...
        if not df.empty:
            ...
            st.warning("Vendas encontradas mas não vinculadas. Verifique se o NS está cadastrado.")
