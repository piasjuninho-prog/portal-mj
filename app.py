...
if not st.session_state.auth:
    ...
    menu = st.sidebar.radio("Navegação", ["📊 Dashboard", "🏫 Clientes", "👤 Vincular", "🚪 Sair"])
    ...
    if menu == "🏫 Clientes":
        ...
        d_sel = st.sidebar.date_input("Filtrar Data", date(2026, 7, 14))
        ...
        if v_res.data and m_res.data:
            ...
            if not df.empty:
                ...
                st.warning("Nenhuma venda vinculada encontrada para hoje.")
